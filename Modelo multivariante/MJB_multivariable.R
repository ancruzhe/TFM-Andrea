...
load("./Archivos_RData/matrizdelmodelo.RData")
...
X2 <- X.full[, c(1,as.vector(which(res.bvs.gibbs$hpm[14:26] == 1))[c(1, 2)], 4, 
                                   as.vector(which(res.bvs.gibbs$hpm[14:26]==1))[c(3, 4, 5)])]
# para que el data.frame este ordenado, ya que las 4 primeras han de corresponder con la variable categórica,
# aunque las únicas seleccionadas por el modelo son la 2 y la 3.
