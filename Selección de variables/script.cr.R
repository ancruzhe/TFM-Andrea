...
load(file = "./Archivos_RData/datos_finales.RData") # los datos, ya listos para su uso, se descargan de un RData.
load(file = "./Archivos_RData/matriz_diseño.RData") # matriz de diselo que al final volvemos a realizarla, y esta nos sirve 
...
save(dat, file = "./Archivos_RData/matrizdelmodelo.RData")
